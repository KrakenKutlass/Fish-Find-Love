...
tellraw @a [{"text":"  Drop ","color":"gray"},{"text":"cod","color":"aqua"},{"text":" near squids, ","color":"gray"},{"text":"glow lichen","color":"aqua"},{"text":" near glow squids to breed (enable in config)","color":"gray"}]
tellraw @a [{"text":"  Use ","color":"gray"},{"text":"/function ffl:config/show_config","color":"yellow","underlined":true,"click_event":{"action":"run_command","command":"/function ffl:config/show_config"}},{"text":" for settings","color":"gray"}]
